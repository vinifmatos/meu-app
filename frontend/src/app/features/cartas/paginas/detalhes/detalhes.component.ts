        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div class="md:col-span-4 lg:col-span-3">
            <div class="sticky top-4">
              <div
                class="relative w-full aspect-[2.5/3.5] rounded-xl shadow-2xl overflow-hidden bg-surface"
              >
                <img
                  [ngSrc]="imagemExibida()"
                  [alt]="carta.name"
          ...
          <div class="md:col-span-8 lg:col-span-9">
            <div class="flex flex-col gap-4">
              <div class="flex justify-between items-start">
                ...
                @if (carta.manaCost) {
                  <div
                    class="text-2xl font-bold px-4 py-2 rounded-full border border-surface shadow-sm flex items-center justify-center shrink-0"
                ...
                <div class="mt-8">
                  ...
                  <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
                    @for (item of listarLegalities(carta.legalities); track item.formato) {
                      <div
                        class="flex flex-col gap-1 p-2 border border-surface rounded-lg bg-emphasis shadow-sm"
                      >
                        <span
                          class="text-[9px] font-extrabold uppercase text-color/70 leading-none"
                          >{{ item.formato }}</span
                        >
                        <div class="flex items-center gap-2">
              ...
              @if (versoes().length > 0) {
                <div class="mt-8">
                  <h3 class="text-2xl font-bold mb-4 uppercase text-surface">
                    ...
                    @for (versao of versoes(); track versao.id) {
                      ...
                      >
                        ...
                        <div class="flex flex-col items-center">
                          <span
                            class="text-[10px] font-bold uppercase text-surface group-hover:text-color-emphasis"
                            >{{ versao.set }}</span
                          >
                        </div>
                      </div>
